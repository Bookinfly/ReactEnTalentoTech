...
const Header = ()=> {
  return (
    <header className="header">
      <a href="#" className="header__link"><img src="./images/logo.png" alt="logo" style={{width:"60px"}} className="header__linl--logo"/></a>
      <div className="header__box">
        <nav className="header__box__nav">
        <ul className="header__box__nav__ul">
          <li className="header__box__nav__ul--link"><a href="#">Almacén</a></li>
          <li className="header__box__nav__ul--link"><a href="#">Ropa</a></li>
          <li className="header__box__nav__ul--link"><a href="#">Electrodomésticos</a></li>
        </ul>
      </nav>

      <a href="#" className="header__box__link">

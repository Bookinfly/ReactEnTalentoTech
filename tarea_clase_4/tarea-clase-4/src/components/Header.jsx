...
const Header = ()=> {
  ...
  return (
    <header className="header"  onMouseLeave={salirDesplegable}>
      <Link to="/" className="header__link" alt="logo"><img src="./images/logo.png" alt="logo" style={{width:"60px"}} className="header__linl--logo"/></Link> {/*revisar clase*/}
      <div className="header__box">
        ...
        <Link to="/cart" className="header__box__link" alt="carrito">
